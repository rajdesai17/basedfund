...
export const FUNDBASE_ABI = parseAbi([
  ...
  'function getIdea(string id) external view returns (tuple(string id, string title, string description, address creator, uint256 totalRaised, uint256 backerCount, uint256 createdAt, bool exists))',
  'function getBackers(string id) external view returns (tuple(address wallet, uint256 amount, uint256 timestamp)[])',
  'function getAllIdeas() external view returns (tuple(string id, string title, string description, address creator, uint256 totalRaised, uint256 backerCount, uint256 createdAt, bool exists)[])',
